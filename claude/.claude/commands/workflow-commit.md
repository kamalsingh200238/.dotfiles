...
- Describe what the change does in plain terms, by effect, not by code. Say what the user or system now sees or can do (e.g. "elements now appear side by side"), not the functions, fields, or classes involved.
