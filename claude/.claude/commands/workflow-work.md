...
- Start the slice from a clean working commit that holds no prior work. If current work is uncommitted, unreviewed, or ambiguous, stop and tell the user to finish review and commit first.
